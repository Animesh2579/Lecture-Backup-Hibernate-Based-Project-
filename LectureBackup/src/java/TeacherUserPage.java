 ...
 * @author LENOVO
 */
public class TeacherUserPage extends javax.swing.JFrame {

    /**
     * Creates new form TeacherUserPage
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherUserPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
